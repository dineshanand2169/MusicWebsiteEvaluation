    ...
    <c:if test="${!empty userList}">
        <table class="table table-dark table-striped-columns">
            <tr>
                ...
                <th width="120">Block User</th>
                <th width="120">Make Admin</th>
            </tr>
            <c:forEach items="${userList}" var="user">
                <tr>
                    ...
                    <td><a href="<c:url value='/admin/blockUser/${user.id}' />" >Block User</a></td>
                     <td><a href="<c:url value='/superAdmin/makeAdmin/${user.id}' />" >Make Admin</a></td>
                </tr>
            </c:forEach>
        </table>
        </c:if>
